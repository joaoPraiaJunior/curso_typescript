...
const formularioTransacao = document.querySelector(elementos.formularioTransacao) as HTMLFormElement;
...
formularioTransacao.addEventListener('submit', (event) => {
	try {
		...
		const inputTipoTransacao = formularioTransacao.tipoTransacao as HTMLSelectElement;
