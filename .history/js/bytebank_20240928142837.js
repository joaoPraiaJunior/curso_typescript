...
formularioTransacao.addEventListener("submit", (event) => {
  ...
  const inputTipoTransacao = formularioTransacao.tipoTranscao.value;
  const inputValor = formularioTransacao.valor.value;
  const inputData = formularioTransacao.data.value;
});
